    ...
    <Wrapper>
      <PromoContainer>
        <Row>
          ...
          <ColPromoPart>
            <Heading theme={themes.DARK}>Marketplace</Heading>
            <Text theme={themes.DARK}>BIT.TEAM is a decentralized platform that aims to offer p2p transactions between parties. Transactions are made directly between users.</Text>
            <Button theme={themes.BLUE}>Invest</Button>
          </ColPromoPart>
        </Row>
      </PromoContainer>
    </Wrapper>
